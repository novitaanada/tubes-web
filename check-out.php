                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="checkout-content">
                            <a href="login.php" class="content-btn">klik disini Untuk Login</a>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <label for="last">Nama Akhir<span>*</span></label>
                            ...
                            <div class="col-lg-6">
                                <label for="phone">No Telpon<span>*</span></label>
                        ...
                        <div class="place-order">
                            ...
                            <div class="order-total">
                                <ul class="order-table">
                                    ...
                                    <li class="fw-normal">Buku Tulis <span>Rp.15.00</span></li>
                                    <li class="fw-normal">Stationary Set <span>Rp.55.000</span></li>
                                    <li class="fw-normal">Seragam SMP <span>Rp.30.000</span></li>
                                    <li class="fw-normal">Subtotal <span>Rp.100.000</span></li>
                                    <li class="total-price">Total <span>Rp.100.000</span></li>
                                </ul>
